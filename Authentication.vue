...
<template>
    <!--会员认证-->
    <div class="cation">
        <h5 >填写<span v-if="user.per_name">企业</span>认证信息</h5>
        <div class="nav" v-if="!user.per_name">
            <ul>
        ...
        <div class="enterprise" v-if="!current">
                    ...
                    <ul>
                        <li>
                            <a>
                                ...
                                <span class="message">
                                    <input v-model="form.en_name" type="text" class="text" placeholder="" >
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.en_regmoney" type="number" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.en_person_name" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.en_person_idcard" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.en_contact" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.enuser_name" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.enuser_idcard" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.enuser_contact" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <!-- <li>
            ...
            <div class="sub_btn">
                <a  @click="postData">保存</a>
            </div>
            <div  class="foot">请上传认证所需要资料，以便顺利通过审核，上传信息及照片仅供平台审核使用，请放心上传</div>
        </div>
        <!-- 个人 -->
                    ...
                    <ul>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="user.per_name" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="user.per_idcard" type="text" class="text" placeholder="请输入身份证号">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="user.per_iphone" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li class="sizePosition">
