                        ...
                        <li>
                            <a>
                                ...
                                <span class="message">
                                    ...
                                    <input v-if="form.en_regmoney" v-model="form.en_regmoney" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li class="sizePosition">
                            <a v-if="user.per_name">
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="user.per_address" type="text" class="text" placeholder="" disabled>
                                </span>
                            </a>
                            <a v-else>
                                <label>工作地点</label>
