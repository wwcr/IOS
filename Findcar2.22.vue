    ...
    <div id="Findcar">
        ...
        <div class="pledge img-page">
            ...
            <div class="license-ul1">
                <div class="li">
                    <div class="img-box" v-model='form.card_img1' @click='zoom(1)'><div class="img-mark"></div><img :src="imgstr.first" v-if="imgstr.first"></div>
                    <div class="upload-btn"><input type="file" @change="upload(1)"></div>
                </div>
                <div class="li">
                    <div class="img-box"  v-model='form.card_img2' @click='zoom(3)'><div class="img-mark"></div><img :src="imgstr.first1" v-if="imgstr.first1"></div>
            ...
            <div class="license-ul1">
                <div class="li">
                    <div class="img-box"  v-model='form.card_img3' @click='zoom(2)'><div class="img-mark"></div><img :src="imgstr.second" v-if="imgstr.second"></div>
                    <div class="upload-btn"><input type="file" @change="upload(2)"></div>
                </div>
                <div class="li">
                    <div class="img-box"  v-model='form.card_img4' @click='zoom(4)'><div class="img-mark"></div><img :src="imgstr.third" v-if="imgstr.third"></div>
                    <div class="upload-btn"><input type="file" @change="upload(4)"></div>
                </div>
                <div class="li">
                    <div class="img-box" v-model='form.card_img5' @click='zoom(5)'><div class="img-mark"></div><img :src="imgstr.four" v-if="imgstr.four"></div>
            ...
            upload: function (id) {
                ...
                reader.onload = function (e) {
                    ...
                    self.Http('units/imgstr', {
                        ...
                        console.log(self.form.card_img2);
                    })
                };
