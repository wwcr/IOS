<template>
    ...
    <div id="Findcar">
                        ...
                        <span>
                            ...
                            <input 
                                ...
                                <div class="aui-list-item-input"
                                    style="position:absolute;top:.05rem;width:1.5rem;overflow:hidden">
        ...
        <div class="pledge">
            <div class='license-title'>机动车登记证书图片</div>
            <div class="picture">
            ...
            <div class='license-title'>签约合同</div>
            <div class="borrow">
                <div>
            ...
            <p class="aptitude">所需资质确定后添加,签署委托查找合同，并提供<span class="pact" @click='contract'>电子合同</span>手动签字</p>
