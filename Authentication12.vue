...
<template>
    ...
    <div class="cation">
        ...
        <!-- 企业 -->
        <div class="enterprise" v-if="!current" v-show="form.en_name">
            <div class="member">
                <h6>企业资料</h6>
                <div class="in_list">
                    <ul>
                        <li>
                            <a>
                                ...
                                <span class="message">
                                    <input ref= 'aaa' v-model="form.en_name" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
                            <a>
                                ...
                                <span class="arrow_right_2"></span>
                                <span class="message">
                                    <input v-model="form.en_regmoney" type="text" class="text" placeholder="">
                                </span>
                            </a>
                        </li>
                        <li>
