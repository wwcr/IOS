    ...
    <div class="wrap">
        ...
        <div class="content"  style='padding-top:1.25rem;'>
            <ul class="nav" v-if="serverType==1">
                <li :class="{'cur':current[0]}" @click="currentChange(0)"><span>查找中</span></li>
                <li :class="{'cur':current[1]}" @click="currentChange(1)"><span>付款中</span></li>
                <li :class="{'cur':current[2]}" @click="currentChange(2)"><span>已找到</span></li>
            </ul>
            <ul class="nav" v-if="serverType==2">
                <li :class="{'cur':current[0]}" @click="currentChange(0)"><span>查找中</span></li>
                <li :class="{'cur':current[1]}" @click="currentChange(1)"><span>付款中</span></li>
                <li :class="{'cur':current[2]}" @click="currentChange(2)"><span>已找到</span></li>
                <li><span class="order" @click="getArticle(4)">
                        时间
                        <span class="sj-box">
            ...
            <v-scroll ref='aaa' :on-refresh="onRefresh" :on-infinite="onInfinite" :dataList="scrollData">
                <div class="list" v-if="current[0]&&list[0]">
