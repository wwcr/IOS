            ...
            <ul>
                <li>
                    <a>
                        ...
                        <label>资料认证</label>
                        <span v-if="info.user_anthen == 1">
                            <span class="arrow_right"></span>
                            <span class="message" @click="href('Authentication_detail')">
                                <p>个人已认证</p>
                            </span>
                        </span>
                        <span v-if="info.user_anthen == 2">
                            <span class="arrow_right"></span>
                            <span class="message" @click="href('Authentication_detail')">
                                <p>企业已认证</p>
                            </span>
                ...
                <li v-if="isVIP">
                    <a @click="href('user/devicemanagement')">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            cancelTel (val) {
                if (val) { //拨打电话
                    window.location.href = 'tel:'+'010-84685465';
                }
                this.telFlag = false  
            },
            outUser: function () {
