    ...
    <div id="Findcar">
            ...
            <ul>
                ...
                <li class="price">
                    <a>
                        ...
                        <span class="message" style="width: 62%;">
                            <input type="text" v-model="form.card_contract" class="text" placeholder="请输入回收截止天数" >
                        </span>
                    </a>
                </li>
            </ul>
        ...
        <div class="in_list1">
            ...
            <div class="car-price">
                <div>
                    <a>
                        <label>车辆佣金</label>
                        <!-- <span class="arrow_right_text" style="color: red;">提示建议8000</span> -->
                        <span class="message" style="width: 59%;margin-left: .9rem;">
                            <input type="text" v-model="form.card_price" placeholder="请输入车辆佣金" class="text">
                        </span>
                    </a>
                </div>
            </div>
            <div class="test-text">
                <span v-if="suggest_money > 0.8">
                    本次建议价: <span>0.80</span>  <span> - {{suggest_money}}</span> 万元
                </span>
                <span v-if="suggest_money < 0.8 && suggest_money>0">
                    本次建议价: <span>0.80</span>万元
                </span>
                <span v-if="suggest_money ==0.00 && !form.card_money">
        ...
        <div class="pledge img-page">
            ...
            <div class="license-ul1">
                <div class="li">
                    <div class="img-box" @click='zoom(1)'><div class="img-mark"></div><img :src="imgstr.first" v-if="imgstr.first"></div>
                    <div class="upload-btn"><input type="file" @change="upload(1)"></div>
                </div>
                <div class="li">
                    <div class="img-box" @click='zoom(3)'><div class="img-mark"></div><img :src="imgstr.first1" v-if="imgstr.first1"></div>
            ...
            <div class="license-ul1">
                <div class="li">
                    <div class="img-box" @click='zoom(2)'><div class="img-mark"></div><img :src="imgstr.second" v-if="imgstr.second"></div>
                    <div class="upload-btn"><input type="file" @change="upload(2)"></div>
                </div>
                <div class="li">
                    <div class="img-box" @click='zoom(4)'><div class="img-mark"></div><img :src="imgstr.third" v-if="imgstr.third"></div>
                    <div class="upload-btn"><input type="file" @change="upload(4)"></div>
                </div>
                <div class="li">
                    <div class="img-box" @click='zoom(5)'><div class="img-mark"></div><img :src="imgstr.four" v-if="imgstr.four"></div>
        ...
        methods: {
            countMoney () {
                if (this.form.card_gps == '是') {
                    this.suggest_money = (this.form.contract_money) * 0.2
                } else {
                    this.suggest_money = (this.form.contract_money) * 0.3
                }
                 this.suggest_money =  this.suggest_money.toFixed(2)
                console.log(this.suggest_money)
            },
            carBrand () { //车辆品牌
                this.infoFlag = true
                this.getData()
            ...
            postData() {
                ...
                let that = this;
                if(this.gpsShow) {
                    let tips = ['车辆品牌', '车牌号码','车牌号码', '合同金额','回收期限','所在位置', 'GPS','车辆佣金','机动车登记图片', '签约合同图片'];
                    let from = this.form;
                    let num = -1;
                    let next = false;
            ...
            upload: function (id) {
                ...
                reader.onload = function (e) {
                    ...
                    self.Http('units/imgstr', {
                        ...
                        layer.loading(false); 
                        if (id == 1 || id == 3) self.form.card_img1 = self.form.card_img1+'^'+res.info;
                        if (id == 2 || id == 4 || id == 5) self.form.card_img2 = self.form.card_img2+'^'+res.info;
            ...
            zoom (id) {
                ...
                layer.open({
                 type: 1,
                 content: '<img src="'+zoom+'" style="height:100%;width:100%;position:fixed; left:0;right:0;bottom:0;top:0;margin: 0 auto;">',
                 anim: 'false',
                 style: 'border:none;',
