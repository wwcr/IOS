    ...
    export default {
        ...
        methods: {
            ...
            postData() {
                ...
                if(this.cards != '' && this.form.card_number != '') {
                     if(this.o == 1){
                ...
                if(this.gpsShow) {
                    let tips = ['车辆品牌', '车辆号码', '合同金额','回收期限','所在位置', 'GPS','车辆佣金','机动车登记图片', '签约合同图片'];
                    let from = this.form;
                    let num = -1;
                    let next = false;
            ...
            zoom (id) {
                ...
                layer.open({
                 type: 1,
                 content: '<img src="'+zoom+'" style="height:100%;width:100%">',
                 anim: 'false',
                 style: 'position:fixed; left:5%;right:5%;bottom:10%; border:none;margin: 0 auto;',
